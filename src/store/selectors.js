...
const tokenNotLoaded = state => get(state, 'token.tokenNotLoaded', true)
export const tokenNotLoadedSelector = createSelector(tokenNotLoaded, status => status)
...
const decorateOrder = (order) => {
  ...
  return({
    ...
    tokenPrice,
    formattedTimestamp: moment.unix(order.timestamp).format('h:mm:ss a D/M/Y')
  })
}
...
const decorateOrderBookOrder = (order) => {
  ...
  return({
    ...order,
    orderType,
    orderTypeClass: (orderType === 'buy' ? RED : GREEN),
